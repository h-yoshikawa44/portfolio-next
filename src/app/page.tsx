...
export default function Home() {
  return (
    <main className="flex min-h-screen w-full flex-col items-center justify-between sm:items-start">
      <header className="bg-brand-primary h-100 w-full px-14 py-22">
        <h1 className="bg-white text-5xl inline-block p-1">
          h-yoshikawa44's Portfolio
        </h1>
        <p className="text-3xl mt-4 bg-white inline-block">
          よしのポートフォリオ
        </p>
      </header>
      <section className="bg-brand-secondary w-full px-14 py-14">
        <h2 className="text-white text-2xl header-double-line mb-2">
          当サイトについて
        </h2>
      ...
      <section className="bg-brand-secondary w-full px-14 py-14">
        ...
        <div className="p-4 bg-brand-primary rounded-xl text-white">
          <div className="grid grid-cols-[1fr_4fr]">
            <div className="p-1 rounded-[50%] bg-white w-26 h-26 flex justify-center items-center">
              <Image
                src={myIcon}
                alt="myIcon"
                width={88}
